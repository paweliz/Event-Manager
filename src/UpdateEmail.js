  ...
  return ( 
    <div className="m-4 flex justify-center">
      ...
      {emailError && <div className="bg-red-500 text-white text-center p-2 mb-4">Please, enter valid email</div>}
        <h3 className="text-lg mb-3">Current email: <strong>{currentUser.email}</strong></h3>
        ...
        <div ><Link className="my-2 px-3 border-b-2 border-transparent hover:shadow-lg hover:border-black transform hover:scale-105" to="/updateprofile">Cancel</Link></div></div></div>
      </form>
    </div>
   );
}

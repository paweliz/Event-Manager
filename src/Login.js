  ...
  return ( 
    <div className="m-4 flex justify-center">
      ...
      {error && <div className="bg-red-500 text-white text-center p-2 mb-4">{error}</div>}
        ...
        <button className="self-center py-2 px-3 border-2 bg-gray-200 shadow hover:shadow-lg hover:bg-black hover:text-white hover:border-black tracking-wider transform hover:scale-105" disabled = {loading} type="submit">Login</button>
        <Link to="/forgotpassword" className="pt-4 self-center hover:border-b-2 hover:border-black">Forgot password?</Link>
        <p className="pt-6 text-sm">Need an account? <Link to="/signup" className="py-1 px-3 border-2 bg-gray-200 shadow hover:shadow-lg hover:bg-black hover:text-white hover:border-black tracking-wider transform hover:scale-105 text-xs rounded">Sign Up</Link></p>
      </div>
      </form>
    </div>
   );

...
const SignUp = () => {
  ...
  const validate = () => {
    ...
    console.log(validEmail.test(emailRef.current.value),emailRef.current.value, validPassword.test(passwordRef.current.value), passwordRef.current.value);    
  ...
  return ( 
    <div className="m-4 flex justify-center">
      ...
      {error && <div className="bg-red-500 text-white text-center p-2 mb-4">{error}</div>}
        ...
        <svg class="w-5 inline-block mx-2" data-darkreader-inline-stroke="" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
        <input className="border-l-2 px-2 focus:outline-none focus:ring-transparent focus:ring-2" type="fullname" name="fullName" ref = {fullNameRef} placeholder="Full Name" onBlur={validate} required/></div>
        <div className="group -mx-4 mb-4 p-1 border-b-2 hover:border-gray-900 focus-within:border-gray-900">
        {emailError && <div className="bg-red-500 text-white text-center p-2 mb-4">Please, enter valid email</div>}
        ...
        <input className="border-l-2 px-2 focus:outline-none focus:ring-transparent focus:ring-2" type="email" name="e-mail" ref = {emailRef} placeholder="E-Mail" onBlur={validate} required/></div>
        {passwordError && <div className="bg-red-500 text-white text-center p-2 mb-4">enter valid password</div>}
        ...
        <input className="border-l-2 px-2 focus:outline-none focus:ring-transparent focus:ring-2" type="password" name="password" ref = {passwordRef} onBlur={validate} placeholder="Password" required/></div>
        <div className="group -mx-4 mb-4 p-1 border-b-2 hover:border-gray-900 focus-within:border-gray-900"><svg class="w-5 inline-block mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path></svg>
